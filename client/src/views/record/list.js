...
//ddd
    return Dep.extend({
        ...
        massActionList: ['remove', 'merge', 'massUpdate', 'export','ictbroadcast'],

        checkAllResultMassActionList: ['remove', 'massUpdate', 'export','ictbroadcast'],
                        ...
                        if ('id' in data) {
                           /* var g_id = JSON.stringify(data.id.group_id);
                            ...
                            var c_name = JSON.stringify(data.id.campaign_type);
                             ...
                             var address = ipaddress.replace (/"/g,'');
